...
<form method="post" action="<% request.getContextPath(); %>/backoffice/produit">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" id="nameNewProduit" placeholder="Saisir le nom ici..."
               value="<c:out value="${ produit.getNom() }"/>">
    </div>
    <div class="form-group">
        <label for="descNewProduit">Description</label>
        <input type="text" class="form-control" name="description" id="descNewProduit"
               placeholder="Saisir la description ici..." value="<c:out value="${ produit.getDescription() }"/>">
    </div>
    <div class="form-group">
        <label for="priceNewProduit">Prix</label>
        <input type="number" step="0.01" class="form-control" name="price" id="priceNewProduit"
               placeholder="Saisir le prix ici..." value="<c:out value="${ produit.getPrix() }"/>">
    </div>
    <button type="submit" name="modifyProduit" class="btn btn-primary">Modifier</button>
</form>
